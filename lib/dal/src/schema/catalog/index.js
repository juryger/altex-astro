...
export const measurementUnits = table("measurement_units", {
...
export const makers = table("makers", {
    id: t.int().primaryKey({ autoIncrement: true }),
    code: t.text().notNull(),
    title: t.text().notNull(),
    uid: t.text().notNull(),
...
export const makeCountries = table("make_countries", {
    id: t.int().primaryKey({ autoIncrement: true }),
    code: t.text().notNull(),
    title: t.text().notNull(),
    uid: t.text().notNull(),
...
export const relatedProducts = table("related_products", {
    id: t.int().primaryKey({ autoIncrement: true }),
